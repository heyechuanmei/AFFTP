...
// +----------------------------------------------------------------------
//由来生云 aftercloud.cn 进行二次编译定制打包
//所用图片全部获得CC0许可,放心使用
//默认的储存文件夹是/data/nfs
//无需数据库.支持php5.3-7.1(建议5.4-7.0)
//优点为使用php上传,高速,可在线预览,可储存到外部
//所用图片在/static/images目录,可自由更改
//可作为网盘使用
//默认账号admin 密码admin888
//定制请联系QQ 2279119754
...
<div id="footer">
	<a href="http://yun.aftercloud.cn" target="_blank">来生云官网</a> -
    <a href="http://4s4.xyz" target="_blank">云后解忧杂货店</a> -
	CopyRight ©2011-2019 <a href="http://yun.aftercloud.cn" target="_blank">aftercloud来生云</a> All Rights Reserved.
</div>
