...
//名称默认为webFTP系统,可以在config.php和index.php两个文件修改
//默认最大单个文件为10G,可在下方更改
...
define('WF_API_URL', 'http://fms.smart.net/admin/user_info.json.php');
...
$_CONFIG = array(
	...
	'UPLOAD' => array(
		...
		'max_file_size' => 10240,  // 上传单个文件限制大小，单位MB
		'filters' => array(
